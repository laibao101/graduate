...
class SettingView extends Component {
            ...
            <ScrollView style={styles.container}>
                ...
                <View style={styles.container}>
                    <View style={{
                        ...
                        <Image style={styles.icon} source={require('../ios/toilet/Images.xcassets/logo.imageset/logo.png')} resizeMode="contain"/>
                        <Text style={[
                            styles.text, {
                                fontSize: 13
                            }
    ...
    _showHelp() {
        this.props.navigator.push({component: Help, title: '帮助中心', barTintColor: '#fff'});
    }

    _showTips() {
        this.props.navigator.push({component: Tips, title: '服务条款', barTintColor: '#fff'});
    }
    ...
    _showDetail() {
        this.props.navigator.push({component: Detail, title: '功能介绍', barTintColor: '#fff'});
